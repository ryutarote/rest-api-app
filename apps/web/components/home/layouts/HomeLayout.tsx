...
export default function HomeLayout({
	...
	useEffect(() => {
		document.title = 'REST API APP PROJECT';
	}, []);
		...
		<>
			<div className='container max-w-full mx-auto p-4'>
				...
				<div className='flex flex-col lg:flex-row mt-0 lg:mt-8 gap-8 sm:gap-12'>
					...
					{/* Main content */}
					<div className='lg:w-[1000px] px-2'>{children}</div>
			...
			<footer className='border-t border-gray-300 bg-gray-100 py-4 mt-12 lg:mt-16'>
				<div className='container mx-auto px-4'>
					<div className='flex flex-col md:flex-row justify-center items-center mb-4'>
						<div className='flex items-center  mb-4 md:mb-0'>
							<h2 className='text-sm text-gray-600 text-center'>
								Powered by{' '}
								<Link href='https://github.com/jaequery/ult' target='_blank'>
									REST API APP
								</Link>
							</h2>
						</div>
					...
					<div className='text-sm text-gray-600 text-center'>
						Copyright © ryutarote. All rights reserved.
					</div>
				</div>
			</footer>
		</>
